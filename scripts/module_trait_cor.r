...
# INPUT FILES PURPLE
# ==============================================================================
EIGENGENE_FILE  <- "/dados04/jorge/comparative_saccharum/files/purple/new/eigengenes_purple.tsv"
METADATA_FILE   <- "/dados04/jorge/comparative_saccharum/china/samplesheet_china.csv"
SUMMARY_FILE    <- "/dados04/jorge/comparative_saccharum/files/purple/new/mcl_purple_module_summary.tsv"
MEMBERSHIP_FILE <- "/dados04/jorge/comparative_saccharum/files/purple/new/mcl_purple_membership.tsv"
EDGE_FILE       <- "/dados04/jorge/comparative_saccharum/files/purple/new/network_purple_filtered_edges.tsv"
...
#EIGENGENE_FILE  <- "/dados04/jorge/comparative_saccharum/files/sugarcane/eigengenes_sugarcane.tsv"
#METADATA_FILE   <- "/dados04/jorge/comparative_saccharum/samplesheet.csv"
#SUMMARY_FILE    <- "/dados04/jorge/comparative_saccharum/files/sugarcane/mcl_sugarcane_module_summary.tsv"
#MEMBERSHIP_FILE <- "/dados04/jorge/comparative_saccharum/files/sugarcane/mcl_sugarcane_membership.tsv"
#EDGE_FILE       <- "/dados04/jorge/comparative_saccharum/files/sugarcane/network_sugarcane_filtered_edges.tsv"
