...
OUTDIR="${BASE}/GET_TFS/new/results/module20"
WORKDIR="${OUTDIR}/work"
...
# --- our networks -----------------------------------------------------------
SC_NODES="${BASE}/files/sugarcane/network_sugarcane_node_metrics.tsv"
PU_NODES="${BASE}/files/purple/new/network_purple_node_metrics.tsv"
SC_NODE_STRIP='\.v[0-9.]+$'      # node ids carry .v2.1; gene ids do not
PU_NODE_STRIP=''

SC_MODULES="${BASE}/files/sugarcane/mcl_sugarcane_membership.tsv"
PU_MODULES="${BASE}/files/purple/new/mcl_purple_membership.tsv"

SC_TF_NET="${BASE}/GET_TFS/new/results/sugarcane/TF_in_network.tsv"
PU_TF_NET="${BASE}/GET_TFS/new/results/purple/TF_in_network.tsv"

SC_CONSERVED="${BASE}/files/network_conservation/conserved_genes_sugarcane_FULL.txt"
PU_CONSERVED="${BASE}/files/network_conservation/conserved_genes_purple_FULL.txt"
