...
OUTDIR="${BASE}/GET_TFS/new/results/myb61"
...
SC_TF="${BASE}/GET_TFS/new/results/sugarcane/TF_no_Orphans.tsv"
PU_TF="${BASE}/GET_TFS/new/results/purple/TF_no_Orphans.tsv"
