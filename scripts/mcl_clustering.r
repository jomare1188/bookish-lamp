...
# CONFIGURATION
# ==============================================================================
INFLATION            <- 2   # MCL Inflation parameter — tune if modules are too big/small
...
OUT_DIR_SUGARCANE <- "/dados04/jorge/comparative_saccharum/files/sugarcane/"
OUT_DIR_PURPLE    <- "/dados04/jorge/comparative_saccharum/files/purple/new/"
...
networks <- list(
  sugarcane = list(
    edge_file = "/dados04/jorge/comparative_saccharum/files/sugarcane/network_sugarcane_augmented_edges.tsv",
    prefix    = file.path(OUT_DIR_SUGARCANE, "mcl_sugarcane") # changed prefix to match algorithm
  ),
  purple = list(
    edge_file = "/dados04/jorge/comparative_saccharum/files/purple/new/network_purple_augmented_edges.tsv",
