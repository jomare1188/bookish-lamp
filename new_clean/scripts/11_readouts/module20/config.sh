...
# Steps 06-08 (the AtMYB59 network readout): 06 needs numpy + pandas, 07 runs topGO.
PYTORCH="${PYTORCH:-/home/genomics/miniconda3/envs/docling/bin/python}"
...
export BASE MUNOZ M20_CSV M20_TRANSCRIPTOME M20_PROTEOME OUTDIR WORKDIR M20_FNA M20_FAA \
       ...
       EVALUE MAX_TARGETS MIN_SCOV THREADS RSCRIPT_PLOT PYTORCH
